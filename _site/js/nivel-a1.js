...
async function getA1Explanations() {
    ...
    try {
        ...
        document.getElementById('modalContent').innerHTML = "<p>No se pudo cargar el contenido de las lecciones. Asegúrate de que Eleventy se ejecutó correctamente y el archivo <code>a1_lessons.json</code> existe en la carpeta <code>_site/data/</code>.</p>";
